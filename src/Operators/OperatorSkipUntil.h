...
#ifndef _OPERATORSKIPUNTIL_h
#define _OPERATORSKIPUNTIL_h
...
public:
	...
	OperatorSkipUntil(ReactiveCondition<T> condition);
...
template <typename T>
OperatorSkipUntil<T>::OperatorSkipUntil(ReactiveCondition<T> condition)
{
