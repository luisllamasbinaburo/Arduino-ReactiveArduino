...
#ifndef _OPERATORTAKEWHILE_h
#define _OPERATORTAKEWHILE_h
...
public:
	...
	OperatorTakeWhile(ReactiveCondition<T> condition);
...
template <typename T>
OperatorTakeWhile<T>::OperatorTakeWhile(ReactiveCondition<T> condition)
{
