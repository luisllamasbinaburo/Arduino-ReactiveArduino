...
#ifndef _OPERATORSKIPWHILE_h
#define _OPERATORSKIPWHILE_h
...
public:
	...
	OperatorSkipWhile(ReactiveCondition<T> condition);
...
template <typename T>
OperatorSkipWhile<T>::OperatorSkipWhile(ReactiveCondition<T> condition)
{
