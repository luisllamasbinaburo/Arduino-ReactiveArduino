...
#ifndef _OPERATORTAKEUNTIL_h
#define _OPERATORTAKEUNTIL_h
...
public:
	...
	OperatorTakeUntil(ReactiveCondition<T> condition);
...
template <typename T>
OperatorTakeUntil<T>::OperatorTakeUntil(ReactiveCondition<T> condition)
{
